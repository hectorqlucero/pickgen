(ns pickgen.core
  (:require
   ...
   [pickgen.models.crud :refer [config KEY]]
   [pickgen.routes.proutes :refer [proutes]]
   [pickgen.routes.routes :refer [open-routes]]
   [pickgen.routes.i18n :refer [i18n-routes]]
   [pickgen.routes.tabgrid :refer [tabgrid-routes]]
   [pickgen.routes.fk-api :refer [fk-api-routes]]
   [pickgen.engine.router :as engine]
   [pickgen.config.loader :as cfg]
