(ns pickgen.layout
  (:require
   ...
   [pickgen.models.crud :refer [config]]
   [pickgen.models.util :refer [user-level user-name]]
   [pickgen.menu :as menu]
...
(defn menus-private [request]
  (let [{:keys [nav-links dropdowns]} (pickgen.menu/get-menu-config)]
