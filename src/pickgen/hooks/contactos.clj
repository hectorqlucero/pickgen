(ns pickgen.hooks.contactos
  "Business logic hooks for contactos entity.
   ...
   Example: src/pickgen/hooks/alquileres.clj
...
(defn before-load
  ...
  (println "[INFO] Loading contactos with params:" params)
  params)
...
(defn after-save
  ...
  (println "[INFO] Contactos saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if contactos can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Contactos deleted successfully. ID:" entity-id)
  {:success true})
