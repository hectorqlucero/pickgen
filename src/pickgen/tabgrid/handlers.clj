(ns pickgen.tabgrid.handlers
  "HTTP handlers for TabGrid AJAX requests"
  (:require
   [ring.util.response :refer [response]]
   [hiccup.core :refer [html]]
   [pickgen.tabgrid.data :as data]
   [pickgen.tabgrid.render :as render]
...
(defn handle-load-subgrid
  ...
  (let [params (:params request)
        ...
        multivalue-field (:multivalue_field params)]

    (try
      (let [records (data/fetch-subgrid-records subgrid-entity parent-id
                                                :foreign-key foreign-key
                                                :multivalue-field multivalue-field
